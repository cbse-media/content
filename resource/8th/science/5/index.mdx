...
graph TD
  root((Forces))
  root --> Contact[Contact Forces]
  root --> NonContact[Non-Contact Forces]
  root --> Effects

  Contact --> Muscular[Muscular Force]
  Contact --> Friction

  NonContact --> Magnetic[Magnetic Force]
  NonContact --> Electrostatic[Electrostatic Force]
  NonContact --> Gravitational[Gravitational Force]

  Effects --> ChangeSpeed[Change Speed]
  Effects --> ChangeDirection[Change Direction]
  Effects --> ChangeShape[Change Shape]
```