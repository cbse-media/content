...
graph TD
  ...
  Micro --> Microbes
  Micro --> HealthVaccines["Health & Vaccines"]

  Physics --> Electricity
  Physics --> ForcePressure["Force & Pressure"]
  Physics --> LightMirrors["Light & Mirrors"]

  Chemistry --> Particles
  Chemistry --> ElementsCompounds["Elements/Compounds"]
  Chemistry --> Solutions

  Astronomy --> MoonPhases["Moon Phases"]
  Astronomy --> Calendars

  Environment --> Ecosystems
  Environment --> ClimateChange["Climate Change"]
```