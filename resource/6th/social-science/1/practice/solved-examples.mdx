...
graph TD
  root((Social Science))
  root --> ThemeA["Theme A: Land and People"]
  root --> ThemeB["Theme B: Tapestry of the Past"]
  root --> ThemeC["Theme C: Cultural Heritage"]
  root --> ThemeD["Theme D: Governance"]
  root --> ThemeE["Theme E: Economic Life"]
  ...
  ThemeB --> History
  ThemeB --> AncientIndia[Ancient India]
  ThemeB --> Identities

  ThemeC --> KnowledgeTraditions[Knowledge Traditions]
  ThemeC --> ArtsFestivals[Arts and Festivals]

  ThemeD --> Democracy
  ThemeD --> LocalGovernment[Local Government]
  ThemeD --> RightsDuties[Rights and Duties]

  ThemeE --> ValueOfWork[Value of Work]
  ThemeE --> Livelihood
  ThemeE --> Resources
```
